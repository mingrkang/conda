...
Census_Blocks, Voting_Precincts, Polling_Places = read_data()

def build_map(loadCensusBlocks=False):
...
st.header("Ming's Streamlit Test App")
st_map = st_folium(combined_map, width=1500)
